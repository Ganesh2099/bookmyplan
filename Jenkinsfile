            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'nexus-credentials', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                        sh 'docker login http://13.202.79.20:8085/repository/bookmyplan/ -u admin -p ${PASSWORD}'
                        echo "Push Docker Image to Nexus : In Progress"
                        sh 'docker tag bookmyplan 13.202.79.20:8085/bookmyplan:latest'
                        sh 'docker push 13.202.79.20:8085/bookmyplan'
        ...
        stage('Clean Up Local Docker Images') {
            steps {
                ...
                sh '''
                    ...
                    docker rmi 13.202.79.20:8085/bookmyplan:latest
